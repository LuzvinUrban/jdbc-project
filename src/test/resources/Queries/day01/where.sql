...
where first_name='Peter';
    ...
    --display firstname,lastname,salary where firstname is David and last_name is Austi
    select  first_name,last_name,salary from EMPLOYEES
where first_name='David' and last_name='Austin';

    --display all information from employees where salary is bigger than 600
    select  * from employees
where SALARY>6000;
...
--display all info from employees where employees_id between 100 and 120
select * from EMPLOYEES
...
--display all information where country id equals,IT
